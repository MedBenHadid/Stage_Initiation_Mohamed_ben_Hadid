...
mysql_select_db("gf2");
$ccl=$_POST["T0"];
$result = mysql_query("SELECT * FROM factfixe WHERE CCL= '$ccl'");
...
$MPL=$_POST["S2"];
$mtf=$_POST["T13"];
$sql="INSERT INTO factfixe VALUES ('$ccl','$nfact','$datefact','$Souscriptions','$abser','$commfixe','$commmobile','$comminter','$autrecomm','$remises','$tva','$redevance','$timbre','$num','$MPL','$mtf')";
...
<html lang="en">
 ...
 <!-- - - - - - - - - - - - - - - - - - Body- - - - - - - - - - - - - - - - - - - -  -->
	...
	<legend>Facture Fixe Télécom</legend>
