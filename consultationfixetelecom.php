...
<head>
  ...
  <body background="tunisair1.jpg">
                ...
                <li class="sidebar-brand">
                 ...
                 <li>
                  ...
                  <ul class="dropdown-menu" role="menu">
                    ...
                    <li><a href="fact Fixe telecom.php style="width: 300px"">Ligne Fixe</a></li>
	...
	<legend>Consultation Facture Fixe Télécom</legend>
        <div class="col-md-3">
    	 ...
    	 <table class="table table-list-search">
                    <thead>
                        <tr>
                            ...
                            <th>Souscriptions</th>
                            <th>Abonnements et services</th>
                            <th>Remises</th>
                            <th>TVA</th>
                            <th>Redevance Télécom</th>
                            <th>Timbre Fiscal</th>
                            <th>Montant Total</th>
        ...
        <td><? echo $row['CCL']; ?></td>
        <td><? echo $row['Nfact']; ?></td>
        <td><? echo $row['DateFact']; ?></td>
        <td><? echo $row['Souscriptions']; ?></td>
        <td><? echo $row['Abon&serv']; ?></td>
        <td><? echo $row['Remises']; ?></td>
        <td><? echo $row['TVA']; ?></td>
        <td><? echo $row['Redevance']; ?></td>
