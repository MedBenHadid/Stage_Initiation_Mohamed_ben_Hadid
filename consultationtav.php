...
<head>
  ...
  <body background="tunisair1.jpg">
	...
	<legend>Consultation Facture OACA</legend>
        <div class="col-md-3">
        ...
        <td><? echo $row['VATRate']; ?></td>
        <td><? echo $row['VATAmount']; ?></td>
        <td><? echo $row['Total']; ?></td>
        <td><? echo $row['Stamptax']; ?></td>
        <td><? echo $row['Amounttobepaid']; ?></td>
        <td><? echo $row['LastPaymentDate']; ?></td>
</tr>
<? }
?>
                    </tbody>
